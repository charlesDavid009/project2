...
class Comment(models.Model):
    ...
    like = models.ManyToManyField(USER, related_name= 'Commnets_likes', through="CommentLikes")
    comments = models.ManyToManyField(USER, related_name= 'Commnets_count')
...
class SubComment(models.Model):
    ...
    user = models.ForeignKey(USER, on_delete = models.CASCADE)
    text = models.TextField()
    like = models.ManyToManyField(USER, related_name= 'SubCommnets_likes', through="SubCommentLikes")
    created = models.DateTimeField(auto_now_add= True)
